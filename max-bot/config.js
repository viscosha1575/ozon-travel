...
export const MAX_CHANNEL_URL = process.env.MAX_CHANNEL_URL || 'https://max.ru/ozontravel';
export const MAX_CHANNEL_CHAT_ID = process.env.MAX_CHANNEL_CHAT_ID || '';
export const MAX_BOT_PUBLIC_URL = process.env.MAX_BOT_PUBLIC_URL || 'https://max.ru/ozontravel_lenta_bot';
